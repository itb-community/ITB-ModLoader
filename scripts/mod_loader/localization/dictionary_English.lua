return {
	...
	["ModConfig_Button_Sort_Tooltip"] = "Choose how to sort mods",
	["ModConfig_Button_Sort_Choice_Name"] = "Name",
	["ModConfig_Button_Sort_Choice_Id"] = "Id",
	["ModConfig_Button_Sort_Choice_Tip_Name"] = "Sort mods alphabetically by their display name.",
	["ModConfig_Button_Sort_Choice_Tip_Id"] = "Sort mods alphabetically by their internal id.",
	["ModConfig_Button_Sort_Enabled_Mods_Title"] = "Enabled Mods:",
	["ModConfig_Button_Sort_Enabled_Mods_Tooltip"] = "Choose how to sort enabled mods",
	["ModConfig_Button_Sort_Enabled_Mods_Choice_First"] = "First",
	["ModConfig_Button_Sort_Enabled_Mods_Choice_Last"] = "Last",
	["ModConfig_Button_Sort_Enabled_Mods_Choice_None"] = "Unsorted",
	["ModConfig_Button_Sort_Enabled_Mods_Choice_Tip_First"] = "Sort enabled mods first, then disabled mods.",
	["ModConfig_Button_Sort_Enabled_Mods_Choice_Tip_Last"] = "Sort disabled mods first, then enabled mods.",
	["ModConfig_Button_Sort_Enabled_Mods_Choice_Tip_None"] = "Do not sort mods based on their enabled status.",
	...
	["ConfigureDeck_PresetSave_Tooltip"] = "Saves the current weapons to the selected preset. If nothing is checked, deletes the current preset.",
	...
	["ConfigureDeck_Mode_Tip_All"] = "Edits weapons for all modes",
	...
	["ConfigureDeck_Preset_Tooltip"] = "Select weapons preset to replace currently selected weapons.",
