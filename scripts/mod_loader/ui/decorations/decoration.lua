...
deco.colors.debugRed =                      sdl.rgba(255, 0, 0, 96)
deco.colors.debugGreen =                    sdl.rgba(0, 255, 0, 96)
deco.colors.debugBlue =                     sdl.rgba(0, 0, 255, 96)
deco.colors.debugYellow =                   sdl.rgba(255, 255, 0, 96)
deco.colors.debugTeal =                     sdl.rgba(0, 255, 255, 96)
deco.colors.debugMagenta =                  sdl.rgba(255, 0, 255, 96)
