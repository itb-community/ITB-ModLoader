...
t.onPilotSelectionExited = Event()
t.onAchievementWindowEntered = Event()
t.onAchievementWindowExited = Event()
t.onOptionWindowEntered = Event()
t.onOptionWindowExited = Event()
t.onLanguageSelectionEntered = Event()
t.onLanguageSelectionExited = Event()
t.onHotkeyConfigurationEntered = Event()
t.onHotkeyConfigurationExited = Event()
t.onProfileSelectionEntered = Event()
t.onProfileSelectionExited = Event()
t.onProfileConfirmEntered = Event()
t.onProfileConfirmExited = Event()
t.onStatisticsWindowEntered = Event()
t.onStatisticsWindowExited = Event()
t.onNewGameWindowEntered = Event()
t.onNewGameWindowExited = Event()
t.onAbandonTimelineWindowEntered = Event()
t.onAbandonTimelineWindowExited = Event()
